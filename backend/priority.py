"""Priority engine: severity × time-to-harm × confidence × context. Never the LLM.

One headline action in the cab. Everything else is logged quietly (timeline).
"""
