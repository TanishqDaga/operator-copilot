...
import { Card, CardHeader, Chip, KV, Source, SyntheticTag } from '../components/ui'
...
function SafetyView() {
  ...
  return (
        <div className="space-y-5">
          <SafetyBanner state={state} variant="hero" meta={meta} />
            ...
            <Card className="xl:col-span-2">
              ...
              <div className="px-5 pb-5">
                ...
                <Source className="mt-4">
                  closing = max(machine speed + person approach, {c.MIN_CLOSING_MS} m/s); ttc = distance ÷ closing. Machine motion is conservatively assumed to be toward the person.
                  {p.source === 'camera' && ' Camera distance is an uncalibrated box-height proxy.'}
                </Source>
              </div>
            </Card>
            <Card>
              <CardHeader icon={SlidersHorizontal} title="Person input" subtitle="Camera detection with slider fallback" right={<SyntheticTag />} />
          ...
          <div className="grid gap-5 xl:grid-cols-3">
            ...
            <Card>
              <CardHeader icon={Wrench} title="Machine & site" subtitle="Seatbelt, travel and weather inputs" right={<SyntheticTag />} />
              <div className="px-5 pb-5">
